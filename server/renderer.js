...
exports.render = function(requestUrl, context, preloadedState, renderApp, webExtractor) {
  ...
  const collectWebChunks = (Comp) => {
    ...
    // const lc =  React.createElement(LoadableContext.Provider, { value: extractor }, Comp);
    // console.log('lc', lc, 'LoadableContext', LoadableContext, 'LoadableContext.Provider', LoadableContext.Provider._consumer);
    // return lc;
  };

  collectWebChunks.bind(webExtractor);
